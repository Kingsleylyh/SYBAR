...
export default function PaymentScreen() {
    ...
    return (
      <View className="flex-1 bg-white">
        ...
        >
          ...
          <Text className="text-[#0F172A] text-xl font-bold mt-2">
            Card Details
          </Text>
        </LinearGradient>
        ...
        <View className="-mt-16 px-6 z-20">
          <View className="bg-[#1E3A8A] rounded-3xl p-6 shadow-lg h-52 justify-between">
            ...
            <View>
              <Text className="text-[#94A3B8] text-xs mb-1 font-medium">
                CARD NUMBER
              </Text>
              <Text className="text-white text-xl tracking-widest font-mono font-bold">
                **** **** **** 7550
              </Text>
            </View>
        ...
        <View className="flex-1 px-6 mt-8 justify-between pb-28">
          <View>
            <Text className="text-gray-500 text-center px-4 leading-6">
              Link your third-party payment gateways securely for route tolls
  ...
  return (
    <View className="flex-1 bg-white">
      ...
      >
        <Text className="text-xl font-bold text-[#0F172A] mb-4">
          Payment Summary
        </Text>
        ...
        <View className="bg-white border border-gray-200 rounded-3xl p-5 mb-6 shadow-sm">
          ...
          <View className="flex-row justify-between mb-6">
            ...
            <View className="flex-1 border-2 border-[#FBBF24] rounded-xl p-3 items-center bg-yellow-50">
              ...
              <Text className="text-[#D97706] font-bold text-base">
                Apr - RM890
              </Text>
            </View>
          </View>
          ...
          <View className="flex-row justify-between items-end h-32 px-2 border-l border-b border-gray-200 pb-1">
            <View className="w-8 h-[45%] bg-[#94A3B8] rounded-t-md">
              <Text className="absolute -bottom-5 text-[10px] text-gray-500 w-8 text-center">
                Jan
              </Text>
            </View>
            <View className="w-8 h-[60%] bg-[#2563EB] rounded-t-md">
              <Text className="absolute -bottom-5 text-[10px] text-gray-500 w-8 text-center">
                Feb
              </Text>
            </View>
            <View className="w-8 h-[35%] bg-[#94A3B8] rounded-t-md">
              <Text className="absolute -bottom-5 text-[10px] text-gray-500 w-8 text-center">
                Mar
              </Text>
            </View>
            <View className="w-8 h-[90%] bg-[#EF4444] rounded-t-md">
              <Text className="absolute -bottom-5 text-[10px] text-[#0F172A] font-bold w-8 text-center">
                Apr
              </Text>
            </View>
            <View className="w-8 h-[75%] bg-[#EF4444] rounded-t-md">
              <Text className="absolute -bottom-5 text-[10px] text-gray-500 w-8 text-center">
                May
              </Text>
            </View>
            <View className="w-8 h-[50%] bg-[#2563EB] rounded-t-md">
              <Text className="absolute -bottom-5 text-[10px] text-gray-500 w-8 text-center">
                Jun
              </Text>
            </View>
